!----------------------------------------------------------------------------------------
!     READS the transition dipole matrix elements and calculates the
!     Dielectric tensor assuming that the system is insulating
!     
...
!           (et**2 - e_L**2 - (0,1)*2*delta*e_L) &   ! Approximation in QE
